...
#python export.py --rknpu --weight runs/train/exp23/weights/best.pt --img 640 --batch 1 --include onnx

#scp runs/train/exp23/weights/best.onnx test@192.168.1.6:/home/test/RKNN_1.6.0/rknn_model_zoo/examples/yolov5/python
